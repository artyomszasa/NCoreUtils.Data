...
public class NestedDocumentSnapshotByKeyComparer(
    ...
    : IComparer<DocumentSnapshot>
{
    ...
    private readonly IComparer<DocumentSnapshot> _outerComparer = outerComparer ?? throw new ArgumentNullException(nameof(outerComparer));
